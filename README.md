...
🔹 **Framework:** TDD, BDD, Hybrid Automation Framework  
...
### 🔹 ParaBank BDD Framework with Cucumber🌱 | Cucumber + Gherkin + POM + Maven + CI/CD + Reporting
...
### 🔹Rest Assured API Framework 🔗 | Rest Assured + TestNG + CI/CD + Reporting
